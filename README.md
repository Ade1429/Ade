        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-8">
                ...
                <div class="md:w-2/3 text-lg leading-relaxed text-gray-700 text-center md:text-left">
                    <p class="mb-4">
                        lkaka;Hello! I'm a dedicated and results-driven Senior Salesforce Administrator with extensive experience in optimizing business processes and maximizing the value of the Salesforce platform. My passion lies in transforming complex requirements into scalable and efficient solutions.
                    </p>
                    <p>
